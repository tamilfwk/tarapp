...
import 'itemgroup_model.dart';
export 'itemgroup_model.dart';
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                FutureBuilder<List<GetigRow>>(
                  future: SQLiteManager.instance.getig(),
                  builder: (context, snapshot) {
                    ...
                    final listViewGetigRowList = snapshot.data!;

                    return ListView.builder(
                      padding: EdgeInsets.zero,
                      shrinkWrap: true,
                      scrollDirection: Axis.vertical,
                      itemCount: listViewGetigRowList.length,
                      itemBuilder: (context, listViewIndex) {
                        final listViewGetigRow =
                            listViewGetigRowList[listViewIndex];
                        return InkWell(
                          splashColor: Colors.transparent,
                          focusColor: Colors.transparent,
                          hoverColor: Colors.transparent,
                          ...
                          onTap: () async {
                            FFAppState().updateItemsStruct(
                              (e) => e
                                ..group = listViewGetigRow.name
                                ..groupid = listViewGetigRow.id,
                            );
                            setState(() {});
                            context.safePop();
                          },
