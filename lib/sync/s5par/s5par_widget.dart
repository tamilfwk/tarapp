...
import 's5par_model.dart';
export 's5par_model.dart';

class S5parWidget extends StatefulWidget {
  const S5parWidget({super.key});

  @override
  State<S5parWidget> createState() => _S5parWidgetState();
}

class _S5parWidgetState extends State<S5parWidget>
    with TickerProviderStateMixin {
  late S5parModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => S5parModel());
